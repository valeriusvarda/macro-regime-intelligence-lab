...
1. Source data must include provenance and availability information.
...
- It does not use random train-test splits for time-dependent evaluation.

## Current Status

Phase 0: repository foundation and evidence baseline.

No dataset, model, result, or performance claim has been published yet.
